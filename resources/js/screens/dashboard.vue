    ...
    export default {
        ...
        methods: {
            ...
            confirmPurgeQueue(queue) {
                ...
                this.purge.message = `Are you sure you want to clear '${queue.name}' queue?`;
        ...
        <div class="card mt-4" v-if="workload.length">
            ...
            <table class="table table-hover table-sm mb-0">
                ...
                <tr v-for="queue in workload">
                    ...
                    <td>
                        <a href="#" title="Clear queued jobs" style="width: 1.5rem; height: 1.5rem;" @click="confirmPurgeQueue(queue)">
                            <svg class="icon fill-danger" viewBox="0 0 24 24">
